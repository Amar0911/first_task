...
from .models import Carousel_movies,Trending_movies,Anime_movies,Indian_movies,Webseries,Hollywood,CustomerDetail

# Register your models here.

@admin.register(Carousel_movies)
class CarouselAdmin(admin.ModelAdmin):
    list_display = ['id','name','movie_vista_original','genre','description','release_year','imdb','rating','starcast','director','producers']
